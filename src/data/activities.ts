...
/* World 6 — Isla de la escritura: gentle typing ramp (letters → words). */
const world6: Activity[] = [
  makeActivity({
    worldId: "island6",
    levelNumber: 1,
    title: "Letras amigas",
    subtitle: "Fila central otra vez",
    instruction: "Presioná la letra que aparece.",
    listenText: "Buscá la letra que aparece en pantalla.",
    targets: ["a", "s", "d", "f", "j", "k", "l"],
    mode: "assisted",
    inputType: "letter",
    difficulty: 1,
    description: "Volvé a calentar los dedos con la fila central.",
  }),
  makeActivity({
    worldId: "island6",
    levelNumber: 2,
    ...
    subtitle: "Dos letras",
    instruction: "Escribí la sílaba que ves.",
    listenText: "Escribí la sílaba que ves en pantalla.",
    targets: ["la", "me", "pi", "so", "tu", "ca"],
    mode: "assisted",
    inputType: "word",
    difficulty: 1,
    description: "Uní dos letras para formar sílabas.",
  }),
  makeActivity({
    worldId: "island6",
    levelNumber: 3,
    title: "Palabras cortitas",
    subtitle: "Tres letras",
    instruction: "Escribí la palabra completa.",
    listenText: "Escribí la palabra completa.",
    targets: ["sol", "pez", "luz", "pan", "voz", "rey"],
    mode: "assisted",
    inputType: "word",
    difficulty: 2,
    description: "Escribí palabras simples de tres letras.",
  ...
  makeActivity({
    ...
    subtitle: "Cuatro letras",
    instruction: "Escribí la palabra que aparece.",
    listenText: "Escribí la palabra que aparece.",
    targets: ["casa", "flor", "nube", "gato", "rana", "mano"],
    mode: "independent",
    inputType: "word",
    difficulty: 2,
    description: "Practicá palabras de cuatro letras.",
  ...
  makeActivity({
    worldId: "island6",
    levelNumber: 5,
    title: "Palabras lindas",
    subtitle: "Cinco letras",
    instruction: "Escribí la palabra que ves.",
    listenText: "Escribí la palabra que ves.",
    targets: ["fruta", "verde", "amigo", "playa", "tigre"],
    mode: "independent",
    inputType: "word",
    difficulty: 3,
    description: "Escribí palabras un poco más largas.",
  ...
  makeActivity({
    ...
    instruction: "Escribí las dos palabras con un espacio.",
    listenText: "Escribí las dos palabras separadas por un espacio.",
    targets: ["sol feliz", "mi gato", "casa verde", "nube azul"],
    mode: "independent",
    inputType: "phrase",
    difficulty: 3,
    description: "Usá la barra espaciadora entre palabras.",
  }),
  makeActivity({
    worldId: "island6",
    levelNumber: 7,
    title: "Escritura veloz",
    subtitle: "Reto de palabras",
    instruction: "Escribí rápido cada palabra que aparece.",
    listenText: "Escribí rápido cada palabra que aparece.",
    targets: ["libro", "mundo", "juego", "tecla", "salto", "globo"],
    mode: "independent",
    inputType: "word",
    difficulty: 3,
    description: "Cerrá la isla con velocidad y precisión.",
  }),
];
